    ...
    return (
        <div className='display'>
            <div className='menu_container'>
                ...
                {props.state.show_menu_page===true && props.showPage === props.curr_ele && props.curr_ele === 1 ? <Music state={props.state} /> : ''}
                {props.state.show_music_page === true && props.state.music_page === props.curr_ele && props.curr_ele === 0 ? <Allsongs /> : ''}
